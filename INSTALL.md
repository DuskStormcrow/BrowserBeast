# BrowserBeast™ v1.0 Install Guide

## Chrome / Chromium Sideload

1. Unzip the BrowserBeast release package.
2. Open `chrome://extensions`.
3. Enable **Developer mode**.
4. Click **Load unpacked**.
5. Select the unzipped `BrowserBeast 1.0` folder.
...
5. Try **Copy Markdown** or **Download .md**.
